...
namespace HostLab4
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Uri baseAddress = new Uri("http://localhost:10004/Student");
            ServiceHost myHost = new ServiceHost(typeof(MyStudent), baseAddress);
            BasicHttpBinding myBinding = new BasicHttpBinding();
            ServiceEndpoint endpoint1 = myHost.AddServiceEndpoint(typeof(IStudent), myBinding, "endpoint1");
